...
log "Use image downloaded in prerequisite step"
mv ~/nanopitools/H3/NanoPi-Duo2/official-ROMs/nanopi-duo2_sd_friendlycore-xenial_4.14_armhf_20190522.img.zip ./
...
unzip "nanopi-duo2_sd_friendlycore-xenial_4.14_armhf_20190522.img.zip" 

log "Rename to IMAGE.img"
mv "nanopi-duo2_sd_friendlycore-xenial_4.14_armhf_20190522.img" "IMAGE.img"
